...
const ROOMS = [
  // Bottom row — Computer Labs & PT Labs
  { id: "1", name: "Computer Lab 1", number: "SBH-Cl1", category: "Education and Training", capacity: 40, x: 240, z: 450, w: 150, d: 90, amenities: ["Whiteboard", "Projector", "Air Conditioning", "Computers"] },
  { id: "2", name: "Computer Lab 2", number: "SBH-Cl2", category: "Education and Training", capacity: 40, x: 420, z: 450, w: 140, d: 90, amenities: ["Whiteboard", "Projector", "Air Conditioning", "Computers"] },
  { id: "3", name: "Computer Lab 3", number: "SBH-Cl3", category: "Education and Training", capacity: 30, x: 575, z: 450, w: 130, d: 90, amenities: ["Whiteboard", "Projector", "Air Conditioning", "Computers"] },
  { id: "6", name: "PT Lab 1", number: "SBH-PTLAB1", category: "Education and Training", x: 818, z: 450, w: 220, d: 90, amenities: ["Workstations", "Lecture Room"] },
  { id: "7", name: "PT Lab 2", number: "SBH-PTLAB2", category: "Education and Training", x: 1127, z: 450, w: 200, d: 90, amenities: ["Workstations", "Lecture Room"] },
  // Top row — Offices, Facilities, Computer Lab 4
  { id: "9", name: "Elevator", number: "SBH-GF-ELEVATOR", category: "Facilities", x: 123, z: 200, w: 65, d: 65, amenities: [] },
  { id: "4", name: "SOCI & CO-CURICULAR Office", number: "SBH-Soci-Office", category: "Office", x: 575, z: 200, w: 170, d: 80, amenities: ["Workstations", "Filing Cabinets", "Air Conditioning"] },
  { id: "5", name: "Stock Room", number: "SBH-Stock-Room", category: "Stock Room", x: 695, z: 200, w: 70, d: 80, amenities: [] },
  { id: "8", name: "PWD/Gender Neutral CR", number: "SBH-PWD-CR", category: "Facilities", x: 772, z: 200, w: 70, d: 80, amenities: [] },
  { id: "11", name: "Comfort Room", number: "SBH-GF-CR", category: "Facilities", x: 1068, z: 200, w: 100, d: 80, amenities: ["Toilet and Sink"] },
  { id: "10", name: "Computer Lab 4", number: "SBH-Cl4", category: "Education and Training", x: 1188, z: 200, w: 150, d: 80, amenities: ["Computers", "Lecture Room"] },
];

const CATEGORY_COLORS = {
  "Education and Training": { base: 0x1e40af, top: 0x3b82f6, height: 28 },
  Office:       { base: 0x065f46, top: 0x10b981, height: 22 },
  "Stock Room": { base: 0x92400e, top: 0xf59e0b, height: 16 },
  Facilities:   { base: 0x4c1d95, top: 0x8b5cf6, height: 16 },
};

// --- Corridor Layout ---
// Top row rooms sit at z=235, bottom row at z=450
// The walkable corridor runs between them at z=340
...
const CORRIDOR_PATHS = [
  // Vertical connector from elevator area down to main hallway
  { points: [{x:123,z:200}, {x:123,z:CORRIDOR_Z}], label: "vert-connector" },
  // Main horizontal hallway (runs between the two rows)
  { points: [{x:123,z:CORRIDOR_Z}, {x:650,z:CORRIDOR_Z}, {x:1200,z:CORRIDOR_Z}], label: "main-hallway" },
  // Approach stubs UP — from hallway up to top-row rooms
  { points: [{x:575,z:CORRIDOR_Z}, {x:575,z:200}], label: "stub-soci" },
  { points: [{x:695,z:CORRIDOR_Z}, {x:695,z:200}], label: "stub-stock" },
  { points: [{x:772,z:CORRIDOR_Z}, {x:772,z:200}], label: "stub-pwd" },
  { points: [{x:1068,z:CORRIDOR_Z}, {x:1068,z:200}], label: "stub-cr" },
  { points: [{x:1188,z:CORRIDOR_Z}, {x:1188,z:200}], label: "stub-cl4" },
  // Approach stubs DOWN — from hallway down to bottom-row rooms
  { points: [{x:240,z:CORRIDOR_Z}, {x:240,z:450}], label: "stub-cl1" },
  { points: [{x:420,z:CORRIDOR_Z}, {x:420,z:450}], label: "stub-cl2" },
  { points: [{x:575,z:CORRIDOR_Z}, {x:575,z:450}], label: "stub-cl3" },
  { points: [{x:818,z:CORRIDOR_Z}, {x:818,z:450}], label: "stub-pt1" },
  { points: [{x:1127,z:CORRIDOR_Z}, {x:1127,z:450}], label: "stub-pt2" },
];

// Direct routes from Elevator (room 9) to each destination
// Each route follows corridors — NEVER passes through another room
// Every room gets its own unique L-shaped or U-shaped path
const DIRECT_ROUTES = {
  // --- Top corridor rooms (down to hallway → across → up to room) ---
  "4":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:575,z:CORRIDOR_Z}, {x:575,z:200}],     // → SOCI Office
  "5":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:695,z:CORRIDOR_Z}, {x:695,z:200}],     // → Stock Room
  "8":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:772,z:CORRIDOR_Z}, {x:772,z:200}],     // → PWD/Gender Neutral CR
  "11": [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:1068,z:CORRIDOR_Z}, {x:1068,z:200}],   // → Comfort Room
  "10": [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:1188,z:CORRIDOR_Z}, {x:1188,z:200}],   // → Computer Lab 4

  // --- Bottom corridor rooms (down to hallway → across → down to room) ---
  "1":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:240,z:CORRIDOR_Z}, {x:240,z:450}],     // → Computer Lab 1
  "2":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:420,z:CORRIDOR_Z}, {x:420,z:450}],     // → Computer Lab 2
  "3":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:575,z:CORRIDOR_Z}, {x:575,z:450}],     // → Computer Lab 3
  "6":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:818,z:CORRIDOR_Z}, {x:818,z:450}],     // → PT Lab 1
  "7":  [{x:123,z:200}, {x:123,z:CORRIDOR_Z}, {x:1127,z:CORRIDOR_Z}, {x:1127,z:450}],   // → PT Lab 2
};

const CENTER_X = 655, CENTER_Z = 325;

// Create a Three.js curve from waypoints.
// Uses straight LineCurve3 segments joined into a CurvePath so corners stay
// sharp and land exactly on the waypoint coordinates (i.e. on the pin/corridor
// intersections) instead of being smoothed across like a CatmullRom would.
