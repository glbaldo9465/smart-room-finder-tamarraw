...
const ROOMS = [
  // Bottom row — Classrooms and Faculty Rooms
  { id: "3f-2", name: "RM 301", number: "SBH-3F-LR1", category: "Education and Training", capacity: 50, x: 100, z: 450, w: 130, d: 90, amenities: ["Whiteboard", "Projector", "Air Conditioning", "Chairs & Tables"] },
  { id: "3f-3", name: "RM 302", number: "SBH-3F-LR2", category: "Education and Training", capacity: 40, x: 260, z: 450, w: 130, d: 90, amenities: ["Whiteboard", "Projector", "Air Conditioning", "Chairs & Tables"] },
  { id: "3f-4", name: "Faculty Room", number: "SBH-3F-FR", category: "Faculty Room", capacity: 15, x: 430, z: 450, w: 140, d: 90, amenities: ["Workstations", "Lockers", "Air Conditioning", "Coffee Maker"] },
  { id: "3f-5", name: "RM 304-A", number: "SBH-3F-RM 304-A", category: "Education and Training", capacity: 30, x: 600, z: 450, w: 130, d: 90, amenities: ["Lab Equipment", "Microscopes", "Air Conditioning"] },
  { id: "3f-6", name: "RM 304-B", number: "SBH-3F-RM 304-B", category: "Education and Training", capacity: 15, x: 760, z: 450, w: 130, d: 90, amenities: ["Whiteboard", "Projector", "Air Conditioning"] },
  { id: "3f-7", name: "RM 305-A", number: "SBH-3F-RM 305-A", category: "Education and Training", capacity: 40, x: 920, z: 450, w: 130, d: 90, amenities: ["Computers", "Projector", "Air Conditioning", "Whiteboard"] },
  { id: "3f-8", name: "RM 305-B", number: "SBH-3F-RM 305-B", category: "Education and Training", capacity: 45, x: 1070, z: 450, w: 130, d: 90, amenities: ["Projector", "Sound System", "Air Conditioning"] },
  { id: "3f-9", name: "RM 306", number: "SBH-3F-RM 306", category: "Stock Room", x: 1210, z: 450, w: 110, d: 90, amenities: ["Shelving", "Cabinets"] },
  { id: "3f-10", name: "Faculty Room", number: "SBH-3F-FR2", category: "Faculty Room", capacity: 15, x: 1360, z: 450, w: 130, d: 90, amenities: ["Workstations", "Lockers", "Air Conditioning"] },
  // Top row — Elevator, Classroom, Comfort Rooms
  { id: "3f-1", name: "Elevator", number: "SBH-3F-ELEVATOR", category: "Facilities", x: 150, z: 200, w: 65, d: 65, amenities: [] },
  { id: "3f-11", name: "RM 307", number: "SBH-3F-RM 307", category: "Education and Training", capacity: 40, x: 1280, z: 200, w: 130, d: 80, amenities: ["Whiteboard", "Projector", "Air Conditioning", "Chairs & Tables"] },
  { id: "3f-12", name: "Male Comfort Room", number: "SBH-3F-MALE-CR", category: "Facilities", x: 1100, z: 200, w: 80, d: 70, amenities: ["Toilet and Sink"] },
  { id: "3f-13", name: "Female Comfort Room", number: "SBH-3F-FEMALE-CR", category: "Facilities", x: 1100, z: 280, w: 80, d: 60, amenities: ["Toilet and Sink"] },
];
...
const CORRIDOR_PATHS = [
  { points: [{x:150,z:200}, {x:150,z:CORRIDOR_Z}], label: "vert-elevator" },
  { points: [{x:100,z:CORRIDOR_Z}, {x:700,z:CORRIDOR_Z}, {x:1360,z:CORRIDOR_Z}], label: "main-hallway" },
  // Stubs down to bottom-row rooms
  { points: [{x:100,z:CORRIDOR_Z}, {x:100,z:450}], label: "stub-301" },
  { points: [{x:260,z:CORRIDOR_Z}, {x:260,z:450}], label: "stub-302" },
  { points: [{x:430,z:CORRIDOR_Z}, {x:430,z:450}], label: "stub-fr1" },
  { points: [{x:600,z:CORRIDOR_Z}, {x:600,z:450}], label: "stub-304a" },
  { points: [{x:760,z:CORRIDOR_Z}, {x:760,z:450}], label: "stub-304b" },
  { points: [{x:920,z:CORRIDOR_Z}, {x:920,z:450}], label: "stub-305a" },
  { points: [{x:1070,z:CORRIDOR_Z}, {x:1070,z:450}], label: "stub-305b" },
  { points: [{x:1210,z:CORRIDOR_Z}, {x:1210,z:450}], label: "stub-306" },
  { points: [{x:1360,z:CORRIDOR_Z}, {x:1360,z:450}], label: "stub-fr2" },
  // Stubs up to top-row rooms
  { points: [{x:1280,z:CORRIDOR_Z}, {x:1280,z:200}], label: "stub-307" },
  { points: [{x:1100,z:CORRIDOR_Z}, {x:1100,z:200}], label: "stub-male" },
  { points: [{x:1100,z:CORRIDOR_Z}, {x:1100,z:280}], label: "stub-female" },
];

// Direct routes from Elevator (room 3f-1) to each destination
// Each route follows corridors — NEVER passes through another room
// Every room gets its own unique L-shaped or U-shaped path
const DIRECT_ROUTES = {
  "3f-2":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:100,z:CORRIDOR_Z}, {x:100,z:450}],
  "3f-3":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:260,z:CORRIDOR_Z}, {x:260,z:450}],
  "3f-4":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:430,z:CORRIDOR_Z}, {x:430,z:450}],
  "3f-5":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:600,z:CORRIDOR_Z}, {x:600,z:450}],
  "3f-6":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:760,z:CORRIDOR_Z}, {x:760,z:450}],
  "3f-7":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:920,z:CORRIDOR_Z}, {x:920,z:450}],
  "3f-8":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:1070,z:CORRIDOR_Z}, {x:1070,z:450}],
  "3f-9":  [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:1210,z:CORRIDOR_Z}, {x:1210,z:450}],
  "3f-10": [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:1360,z:CORRIDOR_Z}, {x:1360,z:450}],
  "3f-11": [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:1280,z:CORRIDOR_Z}, {x:1280,z:200}],
  "3f-12": [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:1100,z:CORRIDOR_Z}, {x:1100,z:200}],
  "3f-13": [{x:150,z:200}, {x:150,z:CORRIDOR_Z}, {x:1100,z:CORRIDOR_Z}, {x:1100,z:280}],
};
...
export default function FloorMap3D3F() {
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          ...
          >
            ...
            {ROOMS.filter(r => r.id !== "3f-1").map(r => (
