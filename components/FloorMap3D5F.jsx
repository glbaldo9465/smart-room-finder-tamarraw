...
const ROOMS = [
  // Bottom row — Classrooms and Labs
  { id: "5f-2", name: "RM 501", number: "SBH-5F-RLAB1", category: "Education and Training", capacity: 20, x: 100, z: 450, w: 130, d: 90, amenities: ["Lab Equipment", "Computers", "Air Conditioning"] },
  { id: "5f-3", name: "RM 502", number: "SBH-5F-RLAB2", category: "Education and Training", capacity: 20, x: 260, z: 450, w: 130, d: 90, amenities: ["Lab Equipment", "Computers", "Air Conditioning"] },
  { id: "5f-4", name: "RM 503", number: "SBH-5F-SEM1", category: "Education and Training", capacity: 30, x: 430, z: 450, w: 140, d: 90, amenities: ["Projector", "Whiteboard", "Air Conditioning", "Conference Table"] },
  { id: "5f-5", name: "RM 504", number: "SBH-5F-SEM2", category: "Education and Training", capacity: 25, x: 600, z: 450, w: 130, d: 90, amenities: ["Projector", "Whiteboard", "Air Conditioning"] },
  { id: "5f-6", name: "RM 505", number: "SBH-5F-SERVER", category: "IT", x: 770, z: 450, w: 130, d: 90, amenities: ["Servers", "Networking Equipment", "UPS", "Cooling System"] },
  { id: "5f-7", name: "RM 506-A", number: "SBH-5F-CL8", category: "Education and Training", capacity: 35, x: 930, z: 450, w: 130, d: 90, amenities: ["High-end Computers", "Projector", "Air Conditioning"] },
  { id: "5f-8", name: "RM 506-B", number: "SBH-5F-THESIS", category: "Education and Training", capacity: 30, x: 1080, z: 450, w: 130, d: 90, amenities: ["Computers", "Printers", "Air Conditioning"] },
  { id: "5f-9", name: "RM 507-A", number: "SBH-5F-RM 507-A", category: "Education and Training", capacity: 30, x: 1230, z: 450, w: 130, d: 90, amenities: ["Whiteboard", "Projector", "Air Conditioning"] },
  { id: "5f-10", name: "Chemistry Laboratory", number: "SBH-5F-CHEMLAB", category: "Education and Training", capacity: 30, x: 1400, z: 450, w: 150, d: 90, amenities: ["Lab Equipment", "Fume Hood", "Air Conditioning", "Safety Showers"] },
  // Top row — Elevator, Computer Lab, Comfort Rooms
  { id: "5f-1", name: "Elevator", number: "SBH-5F-ELEVATOR", category: "Facilities", x: 140, z: 200, w: 65, d: 65, amenities: [] },
  { id: "5f-11", name: "Computer Laboratory 5", number: "SBH-5F-CL5", category: "Education and Training", capacity: 35, x: 1300, z: 200, w: 160, d: 100, amenities: ["Computers", "Projector", "Air Conditioning", "Whiteboard"] },
  { id: "5f-12", name: "Male Comfort Room", number: "SBH-5F-MALE-CR", category: "Facilities", x: 1100, z: 200, w: 80, d: 70, amenities: ["Toilet and Sink"] },
  { id: "5f-13", name: "Female Comfort Room", number: "SBH-5F-FEMALE-CR", category: "Facilities", x: 1100, z: 280, w: 80, d: 60, amenities: ["Toilet and Sink"] },
];

const CATEGORY_COLORS = {
  "Education and Training": { base: 0x1e40af, top: 0x3b82f6, height: 28 },
  IT:           { base: 0x312e81, top: 0x6366f1, height: 22 },
...
const CORRIDOR_PATHS = [
  { points: [{x:140,z:200}, {x:140,z:CORRIDOR_Z}], label: "vert-elevator" },
  { points: [{x:100,z:CORRIDOR_Z}, {x:700,z:CORRIDOR_Z}, {x:1400,z:CORRIDOR_Z}], label: "main-hallway" },
  { points: [{x:100,z:CORRIDOR_Z}, {x:100,z:450}], label: "stub-501" },
  { points: [{x:260,z:CORRIDOR_Z}, {x:260,z:450}], label: "stub-502" },
  { points: [{x:430,z:CORRIDOR_Z}, {x:430,z:450}], label: "stub-503" },
  { points: [{x:600,z:CORRIDOR_Z}, {x:600,z:450}], label: "stub-504" },
  { points: [{x:770,z:CORRIDOR_Z}, {x:770,z:450}], label: "stub-505" },
  { points: [{x:930,z:CORRIDOR_Z}, {x:930,z:450}], label: "stub-506a" },
  { points: [{x:1080,z:CORRIDOR_Z}, {x:1080,z:450}], label: "stub-506b" },
  { points: [{x:1230,z:CORRIDOR_Z}, {x:1230,z:450}], label: "stub-507a" },
  { points: [{x:1400,z:CORRIDOR_Z}, {x:1400,z:450}], label: "stub-chemlab" },
  { points: [{x:1300,z:CORRIDOR_Z}, {x:1300,z:200}], label: "stub-cl5" },
  { points: [{x:1100,z:CORRIDOR_Z}, {x:1100,z:200}], label: "stub-male" },
  { points: [{x:1100,z:CORRIDOR_Z}, {x:1100,z:280}], label: "stub-female" },
];

// Direct routes from Elevator (room 5f-1) to each destination
// Each route follows corridors — NEVER passes through another room
// Every room gets its own unique L-shaped or U-shaped path
const DIRECT_ROUTES = {
  "5f-2":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:100,z:CORRIDOR_Z}, {x:100,z:450}],
  "5f-3":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:260,z:CORRIDOR_Z}, {x:260,z:450}],
  "5f-4":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:430,z:CORRIDOR_Z}, {x:430,z:450}],
  "5f-5":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:600,z:CORRIDOR_Z}, {x:600,z:450}],
  "5f-6":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:770,z:CORRIDOR_Z}, {x:770,z:450}],
  "5f-7":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:930,z:CORRIDOR_Z}, {x:930,z:450}],
  "5f-8":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:1080,z:CORRIDOR_Z}, {x:1080,z:450}],
  "5f-9":  [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:1230,z:CORRIDOR_Z}, {x:1230,z:450}],
  "5f-10": [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:1400,z:CORRIDOR_Z}, {x:1400,z:450}],
  "5f-11": [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:1300,z:CORRIDOR_Z}, {x:1300,z:200}],
  "5f-12": [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:1100,z:CORRIDOR_Z}, {x:1100,z:200}],
  "5f-13": [{x:140,z:200}, {x:140,z:CORRIDOR_Z}, {x:1100,z:CORRIDOR_Z}, {x:1100,z:280}],
};

const CENTER_X = 750, CENTER_Z = 325;
...
function buildScene(canvas) {
  ...
  ROOMS.forEach((room) => {
    const config = CATEGORY_COLORS[room.category] || CATEGORY_COLORS["Education and Training"];
...
export default function FloorMap3D5F() {
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          ...
          >
            ...
            {ROOMS.filter(r => r.id !== "5f-1").map(r => (
